...
class PerceptionTransformer(BaseModule):
    ...
    def forward(self,
        ...
        if 'return_intermediate' in kwargs and kwargs['return_intermediate']:
            bev_embed, feat_flatten, spatial_shapes, level_start_index = self.get_bev_features(
                mlvl_feats,
                bev_queries,
                bev_h,
                bev_w,
            ...
            bev_embed = self.get_bev_features(
                ...
                bev_pos=bev_pos,
                prev_bev=prev_bev,
                **kwargs)  # bev_embed shape: bs, bev_h*bev_w, embed_dimss
        ...
        if 'return_intermediate' in kwargs and kwargs['return_intermediate']:
            return bev_embed, inter_states, init_reference_out, inter_references_out, feat_flatten, spatial_shapes, level_start_index
        else:
